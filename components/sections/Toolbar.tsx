...
import { Home, Notebook, Mail, Moon, Sun } from 'lucide-react'
...
export const Toolbar = () => {
  ...
  const navItems = [
    ...
    },
    {
      icon: null,
      label: 'GitHub',
      href: 'https://github.com/absar22',
      type: 'social',
      svg: (
        <svg viewBox="0 0 438.549 438.549" className="size-4 transition-transform duration-200 hover:scale-110">
          <path
            fill="currentColor"
    ...
    },
    {
      icon: null,
      label: 'WhatsApp',
      href: 'https://wa.me/8209786636',
      type: 'social',
      svg: (
        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" className="size-4 transition-transform duration-200 hover:scale-110">
    ...
    },
    {
      ...
      type: 'social',
      svg: (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-4 transition-transform duration-200 hover:scale-110">
    ...
    },
    {
      icon: null,
      label: 'Upwork',
      href: 'https://www.upwork.com/freelancers/~0194e32a7547cecec4?mp_source=share',
      type: 'social',
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="size-4 transition-transform duration-200 hover:scale-110">
          <path
            fill="#14A800"
    ...
    },
    {
      icon: Mail,
      label: 'Email',
      href: 'mailto:absarahmad137@gmail.com?subject=Let\'s Connect&body=Hi Absar,%0D%0A%0D%0AI came across your portfolio and wanted to reach out. Here\'s what I\'d like to discuss:%0D%0A%0D%0A[Please describe your project, collaboration idea, or question]%0D%0A%0D%0ALooking forward to hearing from you!%0D%0A%0D%0ABest,%0D%0A[Your Name]',
      type: 'link',
    },
  ]

  return (
    <div className="fixed bottom-6 left-1/2 z-50 -translate-x-1/2 pointer-events-auto">
      <div className="w-max p-2 rounded-full border bg-background [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] transform-gpu dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]">
        <div className="flex items-center gap-0">
          ...
          <div
            ...
            role="none"
            className="shrink-0 bg-border w-[1px] h-full py-2 mx-0"
          />
          ...
          >
            ...
            >
              {theme === 'dark' ? (
                <Moon className="h-[1.2rem] w-[1.2rem] text-neutral-200" />
              ) : (
